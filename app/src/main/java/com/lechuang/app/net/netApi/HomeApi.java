...
import com.lechuang.app.model.bean.HomeScrollTextViewBean;
...
//    Observable<ResultBean<SoufanliResultBean>> soufanliProduct(@Field("page") int page);
//
    /**
     * 分类接口
     * 入参 无
...
//    Observable<ResultBean<GetBeanTablayout>> lastTabList();
    ...
    Observable<ResultBean<HomeTipoffListBean>> gunDongText();
    /**
     * 首页滚动商品的数据
     */
    @POST(QUrl.gunDongTextProduct)
    Observable<ResultBean<HomeGunDongTextBean>> gunDongTextProduct();
//    /**
//     *视屏列表接口
//     *
//     * @param page 分页加载页数
//     */
//    @FormUrlEncoded
//    @POST(QUrl.getVideoProduct)
//    Observable<ResultBean<VideoDataBean>> videoProduct(@Field("page") int page);
//
//    /**
//     * 商品详情
//     */
