...
public class DemoTradeCallback implements AlibcTradeCallback {
    private final String TAG = "DemoTradeCallback";
    ...
    public void onTradeSuccess(TradeResult tradeResult) {
        ...
        if (tradeResult.resultType.equals(ResultType.TYPECART)) {
            //加购成功
            Toast.makeText(App.getInstance(), "加购成功", Toast.LENGTH_SHORT).show();
        } else if (tradeResult.resultType.equals(ResultType.TYPEPAY)) {
            //支付成功
            Logger.e(TAG,"支付成功:" + tradeResult.payResult.paySuccessOrders);
            //订单编号list集合遍历String，如：111,222,333
            String orderId = "";
    ...
    public void onFailure(int i, String s) {
        Toast.makeText(App.getInstance(), "网络异常，请检查网络", Toast.LENGTH_SHORT).show();
    }
}
